...
fetch('/account_info')
    ...
    .then(data => {
        ...
        const balance = data.balance || parseFloat(localStorage.getItem("balance"));
...
function getBalance() {
    return parseFloat(localStorage.getItem("balance")) || 50000; // Fallback to 50,000 if not found
}
...
// Logout functionality (do not clear balance to retain balance across sessions)
function logout() {
